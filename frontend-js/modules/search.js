...
export default class Search {
  //   1. properties that select dom elements and keep track of any useful data
  constructor() {
  ...
  renderResultsHTML(posts) {
    if (posts.length) {
      ...
      this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Sorry we Could not find any results marching your search</p>`;
    }
    this.hideLoaderIcon();
